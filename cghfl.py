...
class KeycloakManager:
    ...
    def get_access_token(self, code, state, next_page):
        try:
            ...
            redirect_url = f'http://localhost:5001/{next_page}?access_token={access_token}'
...
keycloak_manager = KeycloakManager(
    ...
    client_id="cghfl_los",
    client_secret="yQDRrtx9MzpEPfYoumrlf09MUn41PU3e",
    redirect_uri="http://localhost:5001/callback"
)

@app.get("/public")
def public_api(request: Request):
    return {"message": "This is a public API for CGHFL"}
